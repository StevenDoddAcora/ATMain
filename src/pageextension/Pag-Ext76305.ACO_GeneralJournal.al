...
pageextension 50305 "ACO_GeneralJournal" extends "General Journal" //Extends page 39 - "General Journal"
{

    //#region "Documentation"
    //>>ABS001 - PMC - 31/07/2019 - This page extension extends page 39 - "General Journal"
    ...
    begin
        DimCombinationJounalType := DimCombHdr.ACO_JournalType::"General Journal";
    end;
