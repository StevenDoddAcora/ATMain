...
pageextension 50307 "ACO_CashReceiptJournal" extends "Cash Receipt Journal" //Extends page 255 - "Cash Receipt Journal"
{
    ...
    //>>ABS001 - PMC - 31/07/2019 - This page extension extends page 255 - "Cash Receipt Journal"
    ...
    begin
        DimCombinationJounalType := DimCombHdr.ACO_JournalType::"Cash Receipt Journal";
    end;
