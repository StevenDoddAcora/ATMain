tableextension 50103 "ACO_VendorLedgerEntry" extends "Vendor Ledger Entry" // It extends table 25 - "Vendor Ledger Entry"
{

    //#region "Documentation"
    //ABS001 - PMC - 01/08/2019 - This table extension extends table 25 - "Vendor Ledger Entry"
    ...
    //3.1.0.2018 LBR 20/02/2020 - CHG003406 (Vendor Entry Query Audit Trail for Dispute Codes) - New logic added
    ...
    fields
    {
        ...
        //>>2.3.0.2018
        field(50010; ACO_VendorName; text[50])
        {
            Caption = 'Vendor Name';
    ...
    begin
        if strlen(ACO_DisputeCode) = 0 then begin
            ...
            if DisputeCode.FindFirst() then begin
                ...
                Management.InsertDisputeComment(Database::"Vendor Ledger Entry", Rec."Entry No.", DisputeCode);
                //>>3.1.0.2018
                Management.UpdDocumentDisputeCode(Database::"Vendor Ledger Entry", Rec."Entry No.", DisputeCode);
                //<<3.1.0.2018
            end else begin
                "On Hold" := '';
            end;
