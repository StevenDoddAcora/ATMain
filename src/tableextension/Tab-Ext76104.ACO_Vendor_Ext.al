tableextension 50104 "ACO_Vendor_Ext" extends Vendor
{
    ...
    {
        //>>2.2.0.2018
        field(50090; "ACO_CreditLimitLCY"; Decimal)
        {
            Caption = 'Credit Limit (LCY)';
            DataClassification = CustomerContent;
            Description = 'Currently this field does not have any logic';
            //Editable = false;
        }
    ...
    procedure OpenCurrVendorLedgerEntries(pCurrencyCode: code[20]; pDate: Date);
    var
    ...
    begin
        ...
        DetailedVendLedgEntry.SetRange("Vendor No.", "No.");
        ...
        VendLedgerEntry.DrillDownOnEntries(DetailedVendLedgEntry);
    end;
